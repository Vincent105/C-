...
public partial class Advanced_Page_10_Repeater : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        #endregion  //上面這一段if判別式，是用來防呆，防止一些例外狀況。-- end --
        ...
        if (haveRec)  
        {
            ...
            {   //有傳來「頁數(p)」，而且頁數正確（大於零），出現<上一頁>、<下一頁>這些功能
                ...
                if (p > 1)
                {   //======== 分頁功能（上一頁 / 下一頁）=========start===                
                    Label1.Text += "<a href='Advanced_Page_10_Repeater_2005.aspx?p=" + (p - 1) + "'>[<<<上一頁]</a>";
                }
                Label1.Text +="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><a href='http://127.0.0.1/'>[首頁]</a></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                if (p < Pages)
                {
                    Label1.Text += "<a href='Advanced_Page_10_Repeater_2005.aspx?p=" + (p + 1) + "'>[下一頁>>>]</a>";
                }   //======== 分頁功能（上一頁 / 下一頁）=========end====
                ...
                if (block_page > 0)           {
                    Label2.Text += "<a href='Advanced_Page_10_Repeater_2005.aspx?p=" + (((block_page - 1) * 10) + 9) + "'> [前十頁<<]  </a>&nbsp;&nbsp;";
                }
                ...
                for (int K = 0; K <= 10; K++)    {
                    ...
                    {   //--- Pages 資料的總頁數。共需「幾頁」來呈現所有資料？
                        ...
                        {   //--- p 就是「目前在第幾頁」
                            ...
                            {
                                Label2.Text += "<a href='Advanced_Page_10_Repeater_2005.aspx?p=" + (block_page * 10 + K) + "'>" + (block_page * 10 + K) + "</a>";
                                Label2.Text += "&nbsp;&nbsp;&nbsp;";
                            }
                        }
                    }
                ...
                {
                    Label2.Text += "&nbsp;&nbsp;<a href='Advanced_Page_10_Repeater_2005.aspx?p=" + ((block_page + 1) * 10 + 1) + "'>  [>>後十頁]  </a>";
                }
                Label2.Text += "</div>";
