...
public partial class GridView_AllowCustomPageing_2005 : System.Web.UI.Page
{
    ...
    protected DataTable MIS2000Lab_GetPageData(int currentPage, int myPageSize)
    {
        ...
        //SqlStr += " where t.RowNo between " + ((currentPage * GridView1.PageSize) + 1) + " and " + ((currentPage * GridView1.PageSize) + myPageSize);
        //==SQL指令的 ROW_NUMBER。參考資料： http://technet.microsoft.com/zh-tw/library/ms186734.aspx 
        ...
        cmd.Parameters.AddWithValue("@Page1", (currentPage * GridView1.PageSize) + 1);
        cmd.Parameters.AddWithValue("@Page2", (currentPage * GridView1.PageSize) + myPageSize);
        //========================
